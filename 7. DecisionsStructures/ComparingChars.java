 ...
 *
 * link: https://www.ssec.wisc.edu/~tomw/java/unicode.html
 *
 */
...
public class ComparingChars{
    public static void main(String[] args){
        ...
        if('A' < 'B'){
            System.out.println("A(65) is less than B(66)");
        }

        if('A' < 'a'){
            System.out.println("A(65) is less than a(97)");
        }

        if(' ' < '0'){
            System.out.println("Space(32) is less than 0(48)");
        }
